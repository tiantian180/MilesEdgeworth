...
sequenceDiagram
    ...
    Loader->>Loader: resolve skin: URLs under root
...
- Studio 导出的 manifest 始终用 `skin:` scheme
- 内置 Miles 已改成 `skin:`，便于将来继续迁出到纯文件系统皮肤包
...
| 资源 URL | manifest 直接写 `qrc:/pet/...` | manifest 写 `skin:assets/...`，loader 解析成绝对 URL |
