...
- `PetRuntime::handlePrimaryClick()` 只保留睡眠、状态和播放入口判断。
...
### Phase 0.58：抽出 PlaybackController 和 RecipeRunner
...
### Phase 0.61：评估 AudioController 和 MotionController
